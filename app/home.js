...
export function renderHomeView(container, { onWorkspaceSelect, onManageUsers }) {
    ...
    <div class="home-view">
      ...
      <header class="home-header">
        ...
        <div class="home-header-right">
          <button class="home-header-btn home-theme-toggle-btn" id="homeThemeToggleBtn" title="Toggle theme">
  ...
  document.getElementById('homeThemeToggleBtn')?.addEventListener('click', toggleTheme);
